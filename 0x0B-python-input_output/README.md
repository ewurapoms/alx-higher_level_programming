...
This project introduces learners to file handling in Python. The builtin `with`,
`open`, and `read` functions are used  with the `json` module to read and write files, and serialize and deserialize objects with JSON.
